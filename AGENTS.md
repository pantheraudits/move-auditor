...
Instructions for Codex when working inside the `move-auditor` repository.
Claude Code uses the equivalent instructions in `CLAUDE.md`.

---

## What this repo is

This is a Codex and Claude Code skill for auditing Move smart contracts on Sui
and Aptos. Codex users install it by copying this directory to
`~/.codex/skills/move-auditor`; Claude Code users install it to
