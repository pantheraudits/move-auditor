...
3. Add your check with:
   - A numbered ID (next available: SUI-11, APT-12, DEFI-83)
...
| Lending / Borrowing | `defi/defi-lending.md` | DEFI-25 to DEFI-34, DEFI-80, DEFI-82 |
| Math / Precision | `defi/defi-math-precision.md` | DEFI-35 to DEFI-42 |
| Slippage / MEV | `defi/defi-slippage.md` | DEFI-43 to DEFI-49 |
| Liquidation | `defi/defi-liquidation.md` | DEFI-50 to DEFI-66, DEFI-81 |
| Auction / CLM | `defi/defi-auction-clm.md` | DEFI-67 to DEFI-73 |
| Signatures | `defi/defi-signatures.md` | DEFI-74 to DEFI-79 |

New DeFi checks should use the next sequential ID (DEFI-83+) and go in the matching subcategory file. If no subcategory fits, create a new `defi/defi-<category>.md` file and register it in `SKILL.md` and `defi-vectors.md`.
